 ...
 */
#pragma once
#ifndef CASPER_PROXY_WORKER_HTTP_DISPATCHER_H_
#define CASPER_PROXY_WORKER_HTTP_DISPATCHER_H_
    ...
    namespace proxy
    {
        ...
        namespace worker
        {
            ...
            namespace http
            {
                ...
                class Dispatcher final : public ::casper::job::deferrable::Dispatcher<casper::proxy::worker::http::Arguments>
                {
                ...
                public: // Method(s) / Function(s)
                    ...
                    void Push (const ::casper::job::deferrable::Tracking& a_tracking, const casper::proxy::worker::http::Arguments& a_args);
...
#endif // CASPER_PROXY_WORKER_HTTP_DISPATCHER_H_
